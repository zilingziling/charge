...
import OutTab from '@/pages/Output/outManage/modal/outTab';
import { connect } from 'dva';
import EditModal from '@/pages/Output/outManage/modal/editModal';
import router from 'umi/router';
import Details from '@/pages/Output/outManage/details';
...
class OutManage extends Component {
  ...
  handleSearch = () => {
    ...
    const { payload } = this.state;
    validateFields(['agentPhone', 'staTime', 'endTime'], (errors, values) => {
  ...
  //   onHandlePage({ key: '/output/outRecord', exportId: id });
  // };
  render() {
    ...
    const { list } = this.props.outPut.outList;
    const columns = [
      {
        title: '操作',
        dataIndex: 'operate',
        render: (text, record) => {
          return (
            <>
              ...
              {/*<a href="javascript:" onClick={() => this.onClickDetails(record)}>*/}
              {/*  详情*/}
              {/*</a>*/}
            </>
          );
      ...
      { title: '快递单号', dataIndex: 'expressNo', editable: true },
      {
        title: '出库日期',
        dataIndex: 'createTime',
        render: text => moment(text).format('YYYY/MM/DD HH:mm:ss'),
      },
      { title: '出库编号', dataIndex: 'id' },
      { title: '出库总量', dataIndex: 'exprotCount' },
      { title: '领取人', dataIndex: 'agentName' },
      { title: '领取人联系方式', dataIndex: 'agentPhone' },
      // { title: '缴纳押金（元）', dataIndex: 'crash' },
